...
test.serial('Agent#findByuuid', async t => {
  ...
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(AgentStub, 'arguments/0/object/object').findByUuid, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AgentStub.findByUuid.called, \'findByUuid should be called on model\')',
    filepath: 'tests/agent-tests.js',
    line: 100,
    async: true,
    ...
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findByUuid","range":[17,27]},{"type":{"label":"."},"range":[27,28]},{"type":{"label":"name"},"value":"called","range":[28,34]},{"type":{"label":","},"range":[34,35]},{"type":{"label":"string"},"value":"findByUuid should be called on model","range":[36,74]},{"type":{"label":")"},"range":[74,75]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findByUuid should be called on model');
});
//# sourceMappingURL=/home/mateo/Documentos/avanzado node js/platziverse/platziverse-db/node_modules/.cache/ava/a1379d672d796d0a7168d5b006da381f.js.map