...
test.beforeEach(async () => {
  ...
  AgentStub.findOne = withArgs(uuidArgs).returns(Promise.resolve(agagentFixtures.byUuid(uuid)));
...
test.serial('Agent#createOrUpdate - existing', async t => {
  let agent = await db.Agent.createOrUpdate;

  t.deepEqual(agent, single, 'agent should be the same');
});
//# sourceMappingURL=/home/mateo/Documentos/avanzado node js/platziverse/platziverse-db/node_modules/.cache/ava/9d83e77c17176bc3f4c096b4ae971568.js.map