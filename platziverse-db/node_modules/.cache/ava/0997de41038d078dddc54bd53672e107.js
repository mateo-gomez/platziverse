...
test.beforeEach(async () => {
  ...
  AgentStub.findAll.withArgs(connected).returns(promise.resolve(agentFixtures.connected));
...
test.serial('Agent#findAll', async t => {
  ...
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(AgentStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec14._capt(connected, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.findAll.calledWith(connected), \'findAll should be show all connected agents\')',
    filepath: 'tests/agent-tests.js',
    line: 107,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findAll","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calledWith","range":[25,35]},"computed":false,"range":[7,35]},"arguments":[{"type":"Identifier","name":"connected","range":[36,45]}],"range":[7,46]},{"type":"StringLiteral","value":"findAll should be show all connected agents","range":[48,93]}],"range":[0,94]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findAll","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calledWith","range":[25,35]},{"type":{"label":"("},"range":[35,36]},{"type":{"label":"name"},"value":"connected","range":[36,45]},{"type":{"label":")"},"range":[45,46]},{"type":{"label":","},"range":[46,47]},{"type":{"label":"string"},"value":"findAll should be show all connected agents","range":[48,93]},{"type":{"label":")"},"range":[93,94]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findAll should be show all connected agents');
});
//# sourceMappingURL=/home/mateo/Documentos/avanzado node js/platziverse/platziverse-db/node_modules/.cache/ava/0997de41038d078dddc54bd53672e107.js.map