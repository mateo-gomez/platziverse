...
test.serial('Agent#findById', async t => {
  ...
  t.true(_rec6._expr(_rec6._capt(_rec6._capt(_rec6._capt(AgentStub, 'arguments/0/object/object').findById, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AgentStub.findById.called, \'findById shouled be called on model\')',
    filepath: 'tests/agent-tests.js',
    line: 93,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findById","range":[17,25]},"computed":false,"range":[7,25]},"property":{"type":"Identifier","name":"called","range":[26,32]},"computed":false,"range":[7,32]},{"type":"StringLiteral","value":"findById shouled be called on model","range":[34,71]}],"range":[0,72]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findById","range":[17,25]},{"type":{"label":"."},"range":[25,26]},{"type":{"label":"name"},"value":"called","range":[26,32]},{"type":{"label":","},"range":[32,33]},{"type":{"label":"string"},"value":"findById shouled be called on model","range":[34,71]},{"type":{"label":")"},"range":[71,72]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findById shouled be called on model');
...
test.serial('Agent#findByuuid', async t => {
  ...
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(AgentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AgentStub.findOne.called, \'findByUuid should be called on model\')',
    filepath: 'tests/agent-tests.js',
    line: 113,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findOne","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"called","range":[25,31]},"computed":false,"range":[7,31]},{"type":"StringLiteral","value":"findByUuid should be called on model","range":[33,71]}],"range":[0,72]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findOne","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"called","range":[25,31]},{"type":{"label":","},"range":[31,32]},{"type":{"label":"string"},"value":"findByUuid should be called on model","range":[33,71]},{"type":{"label":")"},"range":[71,72]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findByUuid should be called on model');
});
...
test.serial('Agent#findAll', async t => {
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(AgentStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec14._expr(_rec14._capt(_rec14._capt(_rec14._capt(AgentStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(AgentStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(), 'arguments/0'), {
...
test.serial('Agent#findConnected', async t => {
  ...
  t.true(_rec16._expr(_rec16._capt(_rec16._capt(_rec16._capt(AgentStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AgentStub.findAll.called, \'findAll should be called on model\')',
    filepath: 'tests/agent-tests.js',
    line: 130,
    async: true,
...
test.serial('agent#findByUsername', async t => {
  ...
  t.true(_rec19._expr(_rec19._capt(_rec19._capt(_rec19._capt(AgentStub, 'arguments/0/object/object').platzi, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AgentStub.platzi.called, \'findByUsername should be called on model\')',
    filepath: 'tests/agent-tests.js',
    line: 141,
    async: true,
    ...
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"platzi","range":[17,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"called","range":[24,30]},{"type":{"label":","},"range":[30,31]},{"type":{"label":"string"},"value":"findByUsername should be called on model","range":[32,74]},{"type":{"label":")"},"range":[74,75]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findByUsername should be called on model');
});
//# sourceMappingURL=/home/mateo/Documentos/avanzado node js/platziverse/platziverse-db/node_modules/.cache/ava/134ff53c75047948910187e3d508843c.js.map